...
packages.used <- c("ggplot2", "dplyr", "tidytext", "wordcloud", "stringr", "ggridges", "SnowballC", "tidyr", "widyr")
...
1. We see that only EAP and HPL uses these accented words. However, there isn't many overlap of the specific words used between the two authors. As a result, it may be more useful to just simply see the proportion of accented words used by each author.
...
1. There isn't much overlap of common accented words between the two authors.
