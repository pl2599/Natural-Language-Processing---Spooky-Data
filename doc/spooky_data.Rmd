...
However, there isn't many overlap of the specific words used between the two authors. As a result, it may be more useful to just simply see the proportion of accented words used by each author.
...
## 7.1 Sentiment Words across Authors
