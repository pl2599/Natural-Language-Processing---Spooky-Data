...
# Counts number of times each author used each word.
author_words <- count(group_by(spooky_wrd_accented, word, author))

# Counts number of times each word was used.
all_words    <- rename(count(group_by(spooky_wrd_accented, word)), all = n)
...
```{r}
words_EAP <- count(group_by(spooky_wrd_accented[spooky_wrd_accented$author == "EAP",], word))$word
freqs_EAP <- count(group_by(spooky_wrd_accented[spooky_wrd_accented$author == "EAP",], word))$n

words_HPL <- count(group_by(spooky_wrd_accented[spooky_wrd_accented$author == "HPL",], word))$word
freqs_HPL <- count(group_by(spooky_wrd_accented[spooky_wrd_accented$author == "HPL",], word))$n
